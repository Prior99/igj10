...
int Game::init() {
    ...
    // Clock
    m_res_manager.load_texture("clock-face", "res/ClockFace.png", m_render);
    m_res_manager.load_texture("clock-hand-ms", "res/ClockHandMS.png", m_render);
    m_res_manager.load_texture("clock-hand-s", "res/ClockHandS.png", m_render);
    // Other
